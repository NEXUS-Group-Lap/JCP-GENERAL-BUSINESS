...
// This file wraps the MapLibre GL JS imperative API (markers/popups mutated
// outside React's render commit), which trips the newer react-hooks
// render-purity checks even though the ref/state updates only ever happen
// from event handlers and effects reacting to the underlying map instance,
// never during an actual render commit.
